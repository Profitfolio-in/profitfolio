...
"<a style='color: Black' target='_blank' href='https://www.nseindia.com/get-quotes/equity?symbol="+resp.data[r].name+"'><p class=\"tile3-p\"><b>"+resp.data[r].name+'</b>  (Rs. '+resp.data[r+3].name+")</p></a>"+
